...
\end{boxverbatim}
  ...
  \begin{center}
    \includegraphics[width=0.8\linewidth]{images/idl_simple_plot}
  \end{center}
...
\end{boxverbatim}
  ...
  \begin{center}
    \includegraphics[width=0.8\linewidth]{images/idl_plot}
  \end{center}
...
\subsection{Loading Data Into VisIt}
  \begin{center}
    \includegraphics[height=0.7\textheight]{images/visit_db_list}
  \end{center}
