...
\newcommand{\version}{4.15.0}

\usepackage{pdfpages}
\usepackage[nottoc,numbib]{tocbibind}
\usepackage{url,graphicx,tabularx,array,booktabs}
...
\usepackage[colorlinks=true,linkcolor=black,anchorcolor=blue,
            citecolor=blue,filecolor=blue,menucolor=blue,runcolor=blue,
            urlcolor=blue]{hyperref}
\usepackage{hologo}
%\usepackage{fix-cm}
\definecolor{txt}{rgb}{0.7,0,0.7}
\definecolor{cmd}{rgb}{0,0.7,0}
...
\newcommand{\warn}{{\color{warwickred}\bf{WARNING: }}}
\newcommand{\inlinecode}[1]{{\color{warwickred} \bf\texttt{#1}}}
\newcommand{\sect}[1]{Section~\ref{sec:#1}}
\newcommand{\sectit}[1]{``{\bf\nameref{sec:#1}}'' (\sect{#1})}
